        ...
        <tbody>
            {Array.from({ length: 40 }, (_, i) => (
                <tr key={i} className="group" data-scroll-page="0" id="ACB">
                    <td
                        className={"scroll-mt-[52px] border-r first:border-l border-light-line dark:border-dark-line text-caption text-[13px] font-bold group-hover:!bg-[#e0ecff] dark:group-hover:!bg-[#17253a] sticky left-0 z-[1] text-light-price-down dark:text-[#FF3737] " + (i % 2 !== 0 ? " dark:bg-[#060606] bg-[#fff] " : " dark:bg-[#262628] bg-[#F3F5F6] ")}
                        data-state="closed">
                    ...
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right text-light-default dark:text-dark-default hidden " + (i % 2 !== 0 ? " dark:bg-[#060606] bg-[#fff] " : " dark:bg-[#262628] bg-[#F3F5F6] ")}
                        data-col="overview_dayValue"
                        id="cell-value-0_overview_dayValue">
                        273,255
                    </td>
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right text-light-price-down dark:text-[#FF3737] " + (i % 2 !== 0 ? " dark:bg-[#060606] bg-[#fff] " : " dark:bg-[#262628] bg-[#F3F5F6] ")}
                    ...
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right text-light-price-down dark:text-[#FF3737] " + (i % 2 !== 0 ? " dark:bg-[#7878802E] bg-[#306BF20D] " : " dark:bg-[#78788061] bg-[#306BF21A] ")}
                    ...
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right text-light-price-down dark:text-[#FF3737] hidden " + (i % 2 !== 0 ? " dark:bg-[#7878802E] bg-[#306BF20D] " : " dark:bg-[#78788061] bg-[#306BF21A] ")}
                    ...
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right text-light-price-ref dark:text-dark-price-ref " + (i % 2 !== 0 ? " dark:bg-[#060606] bg-[#fff] " : " dark:bg-[#262628] bg-[#F3F5F6] ")}
                    ...
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right text-light-price-up dark:text-[#0BDF39] " + (i % 2 !== 0 ? " dark:bg-[#060606] bg-[#fff] " : " dark:bg-[#262628] bg-[#F3F5F6] ")}
                    ...
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right text-light-price-up dark:text-[#0BDF39] " + (i % 2 !== 0 ? " dark:bg-[#7878802E] bg-[#306BF20D] " : " dark:bg-[#78788061] bg-[#306BF21A] ")}
                    ...
                    <td
                        className={"xl:pr-1 py-1 group-hover:bg-[#e0ecff] dark:group-hover:bg-[#17253a] relative text-caption first:border-t-0 border-r first:border-l border-light-line dark:border-dark-line text-right " + (i % 2 !== 0 ? " dark:bg-[#060606] bg-[#fff] " : " dark:bg-[#262628] bg-[#F3F5F6] ")}
