        ...
        >
            <div className="flex items-center gap-20">
                ...
                <div className="flex flex-1 gap-2 2xl:gap-12">
                    <div><a className="flex items-center gap-1.5 py-0.5 px-4 rounded-[20px] transition-all cursor-pointer min-w-max hover:bg-v3-btn-light-disabled/25 dark:hover:bg-v3-btn-dark-disabled/25" href="/e-board"><span className="w-full font-medium text-center text-body4">Bảng giá</span></a></div>
                </div>
            </div>
            <div className="flex items-center justify-end flex-1 gap-4 mt-1">
                <div className="!h-[28px] text-[10px]">
                    <div className="rounded-md flex justify-center items-center px-2 bg-v3-bg-light-input dark:bg-v3-bg-dark-input border-[1px] border-neutral-12 dark:border-black-3 text-neutral-1 dark:text-text-1 focus:border-primary-1 hover:border-primary-1  h-[36px] text-[14px] pointer-events-none max-w-[230px] !h-[28px] !text-[12px] float-right">
