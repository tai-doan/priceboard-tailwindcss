const HeaderIndex = () => {
    return (
        <div className="snap-start flex-shrink-0 max-w-[210px] 2xl:max-w-fit">
            <div
                className="h-[90px] border border-v3-line-light-1 dark:border-v3-line-dark-1 w-[361]"
            >
                <div className="relative w-full h-full">
                    <div id="chart-VNIndex" className="relative w-full h-full">
                        ...
                        >
                            <table cellSpacing={0} style={{ height: 88, width: 358 }}>
                                <tbody>
                                    <tr>
                                        <td style={{ padding: 0 }} />
                                        <td
                        ...
                        <div className="space-y-1">
                            <div>
                                <div className="flex items-center gap-1">
                                    ...
                                    />{" "}
                                    Giá: <span style={{ color: "#DB4343" }}>1,306.9</span>
                                </div>
                                <div className="flex items-center gap-1">
                                    <div
                                        style={{
                    ...
                    <div className="flex items-center flex-shrink-0 gap-1 text-v3-chart-light-text-red dark:text-v3-chart-dark-text-red">
                        ...
                        >
                            <g id="Group 7912">
                                <path
                                    id="Vector"
                                    d="M8.54077 7.41797L4.99996 10.9588L1.45912 7.41797"
                                    stroke="currentColor"
                                    strokeWidth="1.5"
                                    strokeMiterlimit={10}
                                    strokeLinecap="round"
                    ...
                    <span className="inline-flex items-center gap-1 text-v3-chart-light-text-green dark:text-v3-chart-dark-text-green">
                        ...
                        >
                            <g id="Group 7912">
                                <path
                                    id="Vector"
                                    d="M1.45898 4.58203L4.9998 1.0412L8.54063 4.58203"
                                    stroke="currentColor"
                                    strokeWidth="1.5"
                                    strokeMiterlimit={10}
                                    strokeLinecap="round"
